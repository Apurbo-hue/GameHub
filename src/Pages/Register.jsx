...
const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        if (!/[A-Z]/.test(password)) {
            setErrorMsg("Password Mmst have a Uppercase letter in the password")
            return
        }
        if (!/[a-z]/.test(password)) {
            setErrorMsg("Password Mmst have a Lowercase letter in the password")
            return
        }
        if (password.length < 6) {
            setErrorMsg("Length must be at least 6 character")
            return
        }
